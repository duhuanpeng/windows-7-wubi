...
icacls "C:\Program Files\Windows NT\TableTextService\TableTextServiceSimplifiedZhengMa.txt" /grant ac:(D,WDAC)
...
icacls "C:\Program Files (x86)\Windows NT\TableTextService\TableTextServiceSimplifiedZhengMa.txt" /grant ac:(D,WDAC)
